...
fig.append_trace(go.Line(x=df_precip['Date/Time'], y=new_historical['Low'], name='Low', line_color='Blue'), row=1, col=1)
fig.append_trace(go.Line(x=df_precip['Date/Time'], y=new_historical['Average'], name='Average', line_color='Blue'), row=1, col=1)
fig.append_trace(go.Line(x=df_precip['Date/Time'], y=new_historical['High'], name='High', line_color='Blue'), row=1, col=1)
