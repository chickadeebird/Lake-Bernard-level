...
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Top of High'], name='Top of High Water Zone', line_color='Red'))
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Top of Normal'], name='Top of Normal Operating Zone', line_color='Purple'))
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Target'], name='Target Operating Level', line_color='Green'))
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Best Practice'], name='Best Practice', line=dict(color='Green', dash='dash')))
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Bottom of Normal'], name='Bottom of Normal Operating Zone', line=dict(color='Purple', dash='dash')))
fig.add_trace(go.Scatter(x=df_precip['Date/Time'], y=new_historical['Bottom of Low'], name='Bottom of Low Water Zone', line=dict(color='Red', dash='dash')))
